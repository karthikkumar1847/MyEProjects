...
<h1 align="center">Output with JSTL</h1>
	...
	<td>${aInfoVO.bankName }<%-- <c:out value="${aInfoVO.bankName }"/> --%><br/>
	
	<tr><td><font size="5" color="red">Account Number : </font>
	<td>${aInfoVO.accountNumber}<%-- <c:out value="${aInfoVO.accountNumber }"/> --%><br/>
	
	<tr><td><font size="5" color="red">SSN : </font>
	<td>${aInfoVO.ssn }<%-- <c:out value="${aInfoVO.ssn }"/> --%>
	</table>
</body>
</html>